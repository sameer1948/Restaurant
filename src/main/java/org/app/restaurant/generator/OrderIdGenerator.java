...
public class OrderIdGenerator implements IdentifierGenerator {
    ...
    private static final DecimalFormat ID_FORMAT = new DecimalFormat("ORDER00000");
    ...
    public Serializable generate(SharedSessionContractImplementor session, Object object) {
        ...
        Long currentCount = (Long) currentSession.createQuery("SELECT COUNT(o) FROM Order o") // Use the entity name "Tax"
                .uniqueResult();

        if (currentCount == null) {
            throw new IllegalStateException("Failed to get the row count from the Order table.");
        }
